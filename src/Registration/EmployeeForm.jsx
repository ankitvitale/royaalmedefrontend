...
const EmployeeForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${BASE_URL}/employeeregister`, formData)
                        ...
                        {employeeList.length > 0 ? (
                            employeeList.map((employee) => (
                                <tr key={employee.id}>
                                    ...
                                    <td>
                                        <button className="employe_delete_btn" onClick={() => handleDeleteEmploye(employee.id)}>Delete</button>
                                    </td>
                                </tr>
                            ))
                        ) : (
