...
function AddCustomer() {
    ...
    const currentItems = filteredBookedCustomers.slice(offset, offset + itemsPerPage);
            ...
            {showCustomerTable && (
                <div className="booked_customer_main_table_wrapper">
                    ...
                    {filteredBookedCustomers.length > 0 ? (
                                        ...
                                        {currentItems.map((item, index) => (
                                            <tr key={index}>
                                                ...
                                                <td>
                                                    <button
                                                        onClick={() =>
                                                            handleShowDetail(item.booking.id)
                                                        }
                        ...
                        <p className="booked_customer_data_not_found" style={{textAlign:"center"}}>No Data Found</p>
                    )}
                </div>
            )}
        </>
