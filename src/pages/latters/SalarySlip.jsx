...
function SalarySlip() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.post(`${BASE_URL}/createsalarySlip`, formdata, {
                headers: {
                ...
                showSalarySlip && (
                    <>
                        ...
                        <div
                            ...
                            <h2 style={{ marginTop: "10px" ,textAlign:"center" }} className='reliveing_letter_heading'>  Salary Slip</h2>
